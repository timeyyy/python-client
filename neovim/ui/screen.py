...
class Screen(object):
    ...
    def eol_clear(self):
        ...
        #print('in screen eol row and cl -> ', str(self.row), str(self.col))
    ...
    def cursor_goto(self, row, col):
        ...
        self.row = row
        self.col = col
        #print('scree cursor Pos is at ', str(row), str(col))
    ...
    def put(self, text, attrs):
        ...
        #print('in screen put ', text,str(self.row), str(self.col))
        cell.set(text, attrs)
